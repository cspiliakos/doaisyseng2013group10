		...
		check.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(flag1 && flag2 && flag3 && flag4 && flag5 && flag6)
				{
					...
					JOptionPane.showMessageDialog(null, "”ı„˜·ÒÁÙﬁÒÈ·.", "‘›ÎÔÚ ·È˜ÌÈ‰ÈÔ˝", JOptionPane.INFORMATION_MESSAGE);	
					player.setWin(true);
	...
	public class TimerClass implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (seconds == 0 && minutes == 0)
			{
				...
				Toolkit.getDefaultToolkit().beep();
				AncientArcadeFrame.this.setVisible(false);
				JOptionPane.showMessageDialog(null, "∏˜·ÛÂÚ.", "‘›ÎÔÚ ·È˜ÌÈ‰ÈÔ˝", JOptionPane.ERROR_MESSAGE);	
				player.setWin(false);
				player.setPlayed(true);
			}
		}
