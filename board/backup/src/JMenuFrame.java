        ...
        info_about_heroes_Action.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
            	...
            	JOptionPane.showMessageDialog(null, 
            			...
            			"’δης: Ο βασιλιάς του κάτω κόσμου (Τάρταρο), θεός του θανάτου και των νεκρών. Αδερφός του Δία και του Ποσειδώνα.\n"+
            			"’ρης: Ο θεός του πολέμου κατά την ελληνική μυθολογία, γιος του Δία και της Ήρας. Αδελφή του ήταν η Έριδα. Εμφανίζεται πολεμοχαρής και προκλητικός και\n"+
            			...
            			"Περσέας: Γιός του Δία και της Δανάης. Παππούς του ήταν ο Ακρίσιος, βασιλιάς του ’ργους. Ο ήρωας αυτός κατάφερε να σκοτώσει την Μέδουσα με την βοήθεια της Αθηνάς.\n"+
